...
class Fixed5StagePlanner(ExperimentPlanner):
    """
    Forces a 5-stage U-Net with fixed feature widths and number of blocks.
    ...
    def get_plans_for_configuration(self,
        ...
        # -----------------------------
        FIXED_NUM_STAGES = 5
        FIXED_FEATURES_PER_STAGE = (16, 32, 64, 128, 256)
        FIXED_BLOCKS_PER_STAGE = (1, 1, 1, 1, 1)
        FIXED_BLOCKS_DECODER = (1, 1, 1, 1)
        ...
        # ----------------------------------------------------
        # Infer pooling topology (truncate to 5 stages)
        # ----------------------------------------------------
        (_, pool_op_kernel_sizes, conv_kernel_sizes, patch_size, shape_must_be_divisible_by) = get_pool_and_conv_props(
            spacing,
            initial_patch_size,
